...
import { SimulationStatusDto, TrainDelayUpdatedNotificationDto, TrainRemovedNotificationDto, MajorEventDto } from './dto';
...
export class SignalRManager {
    ...
    private setupRemoteEventHandlers(): void {
        ...
        this.connection.on('MajorEventOccurred', (data) => {
            this.handleMajorEventOccurred(data);
        });
    ...
    private handleMajorEventOccurred(data: MajorEventDto): void {
        this._eventManager.emit('majorEventOccurred', data);
    }
